...
This file complements :mod:`neighbayes.tests.test_bayesian_diagnostics`,
...
#
# neighbayes implements the *Bayesian* LM tests of Doğan et al. (2021):
#
...
# already verify that the neighbayes code matches the Doğan formula to
