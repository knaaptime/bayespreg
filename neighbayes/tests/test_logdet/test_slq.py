...
from neighbayes._logdet._slq import _arnoldi_iteration, _batched_lanczos
...
class TestSLQExactMoments:
    ...
    def test_scalar_and_vector_evaluators_agree_under_correction(self):
        ...
        from neighbayes._logdet._slq import (
            slq_logdet_eval,
            slq_logdet_eval_vec,
            slq_logdet_precompute,
        )
    ...
    def test_correction_vanishes_at_rho_zero(self):
        ...
        from neighbayes._logdet._slq import slq_logdet_eval, slq_logdet_precompute
