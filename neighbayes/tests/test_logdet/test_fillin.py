"""Tests for fill-in estimation in :mod:`neighbayes._logdet._fillin`."""

import numpy as np
import pytest
import scipy.sparse as sp

from neighbayes._logdet._fillin import estimate_fillin_ratio
...
class TestEstimateFillinRatio:
    ...
    def test_pure_python_fallback_matches(self):
        ...
        from neighbayes._logdet._fillin import _estimate_w2_nnz
