...
# Pin the package-wide default sampler to PyMC's C-backend NUTS for
# deterministic test behavior.  The package default is "blackjax", but
# many MCMC-based tests use very small ``draws`` for speed and their
