...
The mixture tables in :mod:`bayespecon.samplers.poisson_reduced._mixture` were
...
from bayespecon.samplers.poisson_reduced._augment import (
    build_augmented_index,
    draw_augmentation,
)
from bayespecon.samplers.poisson_reduced._mixture import (
    MAX_TABULATED_SHAPE,
    mixture_for_shape,
